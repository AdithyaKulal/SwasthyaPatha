    ...
    <div className="mx-auto flex min-h-[calc(100vh-200px)] max-w-6xl items-center justify-center px-6 py-16">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-slate-600">Join SwasthyaPatha and take control of your health</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link to="/sign-in" className="font-semibold text-brand-primary hover:text-brand-secondary">
            Sign in
          </Link>
        </p>
      </div>
